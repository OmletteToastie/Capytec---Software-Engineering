...
public class EditAccount extends JFrame {
	...
	public EditAccount() {
		...
		JLabel lblTitle = new JLabel("Edit Account");
		...
		lblActive.setBounds(33, 269, 93, 14);
		contentPane.add(lblActive);
		
		JCheckBox fieldActive = new JCheckBox("");
		fieldActive.setBounds(215, 267, 27, 23);
		contentPane.add(fieldActive);
		...
		btnSubmit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(username.equals("") || password.equals("") || fname.equals("") || sname.equals("")) {
					...
					data.UpdateEmployee(EmployeeManager.selectedUserID, fname, sname, username, password, active, preferredTask, admin, management);
					JOptionPane.showMessageDialog(contentPane, "Edit Successful");
					dispose();
				}
			}
		});
		
		btnSubmit.setBounds(240, 300, 90, 23);
		...
		btnCancel.setBounds(125, 300, 90, 23);
